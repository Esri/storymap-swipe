	...
	({
		...
		builder: {
			...
			settingsExtent: {
				...
				settingsExtentExplainBottom: "Het extent dat u definieert, past het begin-extent van de webmap aan.",
		...
		swipe: {
			...
			settingsDataModel: {
				...
				settingsDataModel1Warning: "Alleen de services Dynamisch, Tile en Image kunnen worden gebruikt. Als de laag door bovenliggende lagen verborgen wordt, heeft swipe geen effect.",
			...
			settingsLegend: {
				...
				settingsLegendHelpTitle: "Inhoud van de legenda verfijnen",
				settingsLegendHelpContent: "Gebruik de inhoudsopgave van de ArcGIS.com webmapviewer (Verbergen in Legenda)",
				preview: "Voorbeeldweergave UI"
			},
			settingsSwipePopup: {
				settingsSwipePopup: "Pop-upvenster",
				settingsSwipePopupExplain: "Pas het uiterlijk aan van de koptekst van pop-ups zodat gebruikers pop-ups aan kaartlagen kunnen koppelen.",
