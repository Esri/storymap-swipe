		...
		return function SettingsPopupTabExtent(titleContainer, contentContainer) 
		{
			...
			function toggleCrossingLineError(display, fatal)
			{
				$(contentContainer)
					.find('.dateLineError')
					.toggle(display)
					.html(fatal ? i18n.builder.settingsExtent.settingsExtentDateLineError2 : i18n.builder.settingsExtent.settingsExtentDateLineError);
			}
			...
			{
				$(titleContainer).html(i18n.builder.settingsExtent.settingsTabExtent);
				
				$(contentContainer).find('p').html(i18n.builder.settingsExtent.settingsExtentExplain);
				$(contentContainer).find('.explain2').html(i18n.builder.settingsExtent.settingsExtentExplainBottom);
				$(contentContainer).find('.dateLineError').html(i18n.builder.settingsExtent.settingsExtentDateLineError);
				
				extentDrawBtn.html(i18n.builder.settingsExtent.settingsExtentDrawBtn);
				extentModifyBtn.html(i18n.builder.settingsExtent.settingsExtentModifyBtn);
				extentUseMainMap.html(i18n.builder.settingsExtent.settingsExtentUseMainMap);
				extentApplyBtn.html(i18n.builder.settingsExtent.settingsExtentApplyBtn);
			}
		}
	}
);