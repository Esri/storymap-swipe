		...
		return function SaveErrorPopupSocial(container)
		{
			...
			this.present = function()
			{
				...
				container.find('.panel1 .help').tooltip({
					title: i18n.swipe.saveErrorSocial.panel1tooltip + '<img src="resources/icons/builder-help-social.png"/>',
					html: true,
					placement: 'left'
				});
				
				container.find('.panel2 .help').tooltip({
					title: i18n.swipe.saveErrorSocial.panel2q1tooltip,
					html: true
				});
			...
			{
				container.find('.modal-title').html(i18n.swipe.saveErrorSocial.title);
				container.find('.panel1lbl').html(i18n.swipe.saveErrorSocial.panel1);
				container.find('.panel2lbl').html(i18n.swipe.saveErrorSocial.panel2);
				container.find('.panel2q1lbl').html(i18n.swipe.saveErrorSocial.panel2q1);
				container.find('.panel2q2lbl').html(i18n.swipe.saveErrorSocial.panel2q2);
				container.find('.panel3').html(i18n.swipe.saveErrorSocial.panel3
					.replace("${MYSTORIES}", '<a href="' + Helper.getMyStoriesURL() + '" target="_blank">' + i18n.swipe.saveErrorSocial.mystories + '</a>'));
				container.find('.panel4lbl').html(i18n.swipe.saveErrorSocial.panel4);
				container.find('.btn-primary').html(i18n.swipe.saveErrorSocial.btnSave);
