...
var nicEditorConfig = bkClass.extend({
        ...
        iconsPath : 'resources/icons/nicEditorIcons.gif',
                                ...
                                switch(type) {
                                        ...
                                        case 'select':
                                                ...
                                                for(opt in field.options) {
														// Changed: var o = new bkElement('option').setAttributes({value : opt, selected : opt == val) ? 'selected' : ''}).setContent(field.options[opt]).appendTo(this.inputs[itm]);
                                                        var o = new bkElement('option').setAttributes({value : opt, selected : opt}).setContent(field.options[opt]).appendTo(this.inputs[itm]);
                                                }
                                                break;
                                        case 'content':
...
var nicLinkButton = nicEditorAdvancedButton.extend({
        addPane : function() {
                ...
                this.addForm({
                        ...
                        'target' : {type : 'select', txt : 'Open In', options : {'_blank' : 'New Window', '' : 'Current Window'},style : {width : '100px'}}
                },this.ln);
        },
