define({
  "viewer": {
    ...
    "errors": {
      ...
      "notAuthorizedBuilder": "אינך מורשה להשתמש באשף הבנייה של Swipe ו-Spyglass.",
  ...
  "swipe": {
    ...
    "settingsLegend": {
      ...
      "settingsPopupDisable": "הפוך חלונית קופצת לפעילה",
      "settingsLocationSearchEnable": "הפעל חיפוש עיגון כתובות",
      "settingsGeolocatorEnable": "הפעל חיפוש מרחבי",
      "settingsLegendHelpContent": "כדי לעדן את תוכן המקרא, השתמש בתוכן העניינים של חלון תצוגת ה-web map של ArcGIS (הסתר במקרא)",
    ...
    "share": {
      ...
      "shareLinkHeader": "שתף את הסיפור שלך",
      "shareLinkOpen": "פתח",
      "learnMore": "מידע נוסף",
