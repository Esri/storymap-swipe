	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				notAuthorizedBuilder: "Não está autorizado a usar Swipe e construtor Spyglass.",
		...
		swipe: {
			...
			settingsLegend: {
				...
				settingsPopupDisable: "Activar pop-up",
				settingsLocationSearchEnable: "Ativar pesquisa de localizadores",
				settingsGeolocatorEnable: "Ativar geolocalizador",
				settingsLegendHelpContent: "Para refinar o conteúdo de legenda, use a tabela de conteúdos do visualizador de mapa web ArcGIS web (Esconder na Legenda)",
			...
			share: {
				firstSaveTitle: "História guardada",
			...
			directCreation: {
				...
				explain2: "Para criar um Swipe ou mapa de história Spyglass, use o botão abaixo para escolher o mapa web existente que pretende usar. Alternadamente, pode colar o ID do mapa web no campo a baixo.",
