	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				notAuthorizedBuilder: "U bent niet gemachtigd om Swipe en Verrekijker builder te gebruiken.",
		...
		swipe: {
			...
			share: {
				firstSaveTitle: "Verhaal opgeslagen",
				...
				shareLinkHeader: "Uw verhaal opslaan",
			...
			directCreation: {
				...
				explain2: "Als u een Swipe- of Verrekijker-kaartverhaal wilt maken, gebruikt u de onderstaande knop om de bestaande webmap die u wilt gebruiken, te selecteren. Of u kunt ook de ID van de webmap in het onderstaande veld plakken.",
