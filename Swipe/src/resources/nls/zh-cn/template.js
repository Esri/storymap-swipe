define({
  "viewer": {
    ...
    "errors": {
      ...
      "notAuthorizedBuilder": "您不具有使用 Swipe 和 Spyglass 构建器的权限。",
  ...
  "swipe": {
    ...
    "settingsLegend": {
      ...
      "settingsLegendHelpContent": "要优化图例内容，请使用 ArcGIS web 地图查看器内容列表(隐藏在图例中)",
    ...
    "directCreation": {
      ...
      "explain2": "要创建卷帘或望远镜故事地图，请使用如下按钮选择想要使用的现有 web 地图。或者，也可以将该 web 地图的 ID 粘贴到如下字段中。",
