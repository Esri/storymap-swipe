define({
  "viewer": {
    ...
    "errors": {
      ...
      "invalidConfigOwner": "Vlasnik priče nema potrebne ovlasti."
    },
    "mobileView": {
  ...
  "builder": {
    "builder": {
      ...
      "popoverOpenViewCancel": "Odustani",
      "popoverSaveWhenDone": "Ne zaboravite spremiti kad završite",
    ...
    "settingsColors": {
      ...
      "settingsColorExplain": "Izaberite temu aplikacije ili postavite svoje boje.",
      "settingsLabelColor": "Pozadinske boje zaglavlja i bočne ploče"
    },
    "settingsHeader": {
      ...
      "settingsLogoSocialExplain": "Prilagodite poveznicu u gornjem desnom kutu zaglavlja.",
  ...
  "swipe": {
    "mobileData": {
      ...
      "noDataMap": "Nema podataka za ovu kartu",
      "noPopup": "Nema skočnog prozora za ovaj geoobjekt"
    },
    "mobileLegend": {
      "noLegend": "Nema legende za prikaz."
    },
    "swipeSidePanel": {
      "editTooltip": "Postavi opis bočne ploče",
      "editMe": "Uredi me!",
      "legendTitle": "Legenda"
    },
    "infoWindow": {
      "noFeature": "Nema podataka za prikaz",
      "noFeatureExplain": "Dodirnite kartu da biste odabrali geoobjekt"
    },
    "settingsLayout": {
      "settingsTabLayout": "Stil klizača",
      "settingsLayoutExplain": "Izaberite stil za alat klizača.",
      "settingsLayoutSwipe": "Okomita traka",
      "settingsLayoutSpyGlass": "Povećalo",
      "settingsLayoutSelected": "Odabrani izgled",
      "settingsLayoutSelect": "Odaberi ovaj izgled",
      "settingsSaveConfirm": "Za neke od vaših promjena potrebno je spremiti i ponovno učitati priču"
    },
    "settingsDataModel": {
      "settingsTabDataModel": "Vrsta klizača",
      "settingsDataModelExplainSwipe": "Za što želite da korisnici upotrijebe klizač?",
      "settingsDataModelExplainSwipe2": "",
      "settingsDataModelExplainSpyGlass": "Izaberite sloj ili web-kartu koja će se prikazati u povećalu.",
      "settingsDataModelOneMap": "Sloj u web-karti",
