	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				notAuthorizedBuilder: "您未取得使用 Swipe 和 Spyglass 建立器的授權。",
		...
		swipe: {
			...
			settingsLegend: {
				...
				settingsPopupDisable: "啟用快顯視窗",
				settingsLocationSearchEnable: "啟用定位器搜尋",
				settingsGeolocatorEnable: "啟用地理定位器",
				settingsLegendHelpContent: "要最佳化圖例內容，請使用 ArcGIS Web 地圖檢視器目錄（隱藏在圖例中）",
			...
			directCreation: {
				...
				explain2: "要建立 Swipe 或 Spyglass 故事地圖，請使用以下按鈕選擇想要使用的現有 Web 地圖。或者，也可以將該 Web 地圖的 ID 貼到以下欄位中。",
