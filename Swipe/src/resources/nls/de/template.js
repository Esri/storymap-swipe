define({
  "viewer": {
    ...
    "errors": {
      ...
      "notAuthorizedBuilder": "Sie sind nicht zur Nutzung des Builders für die Swipe- und Spyglass-App berechtigt.",
  ...
  "swipe": {
    ...
    "settingsLegend": {
      ...
      "settingsLegendHelpContent": "Verwenden Sie das Inhaltsverzeichnis des ArcGIS-Webkarten-Viewers, um den Legendeninhalt zu optimieren (In Legende ausblenden)",
    ...
    "share": {
      ...
      "shareLinkHeader": "Story freigeben",
    ...
    "directCreation": {
      ...
      "explain2": "Verwenden Sie zum Erstellen einer Swipe oder Spyglass Story Map die folgende Schaltfläche, um die vorhandene Webkarte auszuwählen, die Sie verwenden möchten. Alternativ können Sie die ID der Webkarte in folgendes Feld einfügen.",
