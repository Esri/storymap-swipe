	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				notAuthorizedBuilder: "Nie masz uprawnień do korzystania z kreatora Zwijanie i lupa.",
		...
		swipe: {
			...
			settingsLegend: {
				...
				settingsPopupDisable: "Włącz okna podręczne",
				settingsLocationSearchEnable: "Włącz wyszukiwanie przy użyciu lokatora",
				settingsGeolocatorEnable: "Włącz geolokator",
				settingsLegendHelpContent: "Aby ulepszyć zawartość legendy, skorzystaj z tabeli zawartości przeglądarki map internetowych ArcGIS (Ukryj w legendzie)",
			...
			share: {
				firstSaveTitle: "Narracja została zapisana",
				...
				shareLinkHeader: "Udostępnij narrację",
			...
			directCreation: {
				...
				explain2: "Aby utworzyć narrację Zwijanie lub Lupa, wybierz istniejącą mapę internetową ArcGIS Online, której chcesz użyć, za pomocą poniższego przycisku. Ewentualnie możesz wkleić do poniższego pola identyfikator mapy internetowej.",
