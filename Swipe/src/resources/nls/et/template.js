define({
  "viewer": {
    ...
    "errors": {
      ...
      "notAuthorizedBuilder": "Teil pole õigust rullimise ja pikksilma koostajat kasutada.",
  ...
  "builder": {
    ...
    "settingsColors": {
      ...
      "settingsColorExplain": "Valige rakendusega seotud teema või määrake värvid.",
      "settingsLabelColor": "Päise ja küljepaneeli taustavärvid"
    },
    "settingsHeader": {
      ...
      "settingsLogoSocialExplain": "Kohandage päist ülemise paremal pool asuva lingi kaudu.",
      "settingsLogoSocialText": "Tekst",
      "settingsLogoSocialLink": "Link",
      "settingsLogoSocialDisabled": "Selle funktsiooni on administraator välja lülitanud"
    },
    "settingsExtent": {
      "settingsTabExtent": "Kuvaulatus",
      "settingsExtentExplain": "Määrake sisemine ulatus läbi alloleva interaktiivse kaardi.",
  ...
  "swipe": {
    "mobileData": {
      ...
      "noDataExplain": "Puudutage kaarti, et valida objekt ning tulgee siia tagasi",
    ...
    "settingsDataModel": {
      ...
      "settingsDataModelExplainSpyGlass": "Valige kiht või veebikaart, mis ilmub pikksilma.",
      "settingsDataModelOneMap": "Kiht veebikaardil",
      "settingsDataModel1Explain": "Valige kiht rullimiseks",
      "settingsDataModel1Warning": "Rullimine ei mõju, kui vastav kiht on peidetud ülemiste kihtide alla.",
      "settingsDataModel1SpyGlassExplain": "Valige kiht, mis ilmub pikksilma.",
      ...
      "settingsDataModel2Explain": "Rullige mõne teise veebikaardiga.",
      "settingsDataModel2SpyGlassExplain": "Näita teises veebikaardis.",
      "settingsDataModel2HelpTitle": "Kuidas leida veebikaardi ID-d?",
      "settingsDataModel2HelpContent": "Kopeerige ja kleepige numbrid pärast '=' märki veebikaardi URL sisust",
    ...
    "settingsLegend": {
      ...
      "settingsLegendHelpContent": "Legendi sisu täpsustamiseks kasutage ArcGIS-i veebikaardi akna kihtide loendit (peida legendis)",
      "settingsSeriesHelpContent": "Rullimiste seeria on vahelehtedega navigeerimise valik, mis viib vaataja konkreetsele kuvaulatusele ja kuvab pealkirja ning kirjeldust küljepaneelil. Algselt aktiveerimiseks imporditakse veebikaardi järjehoidjad ja kasutatakse seeriate lehe eelgenereerimiseks. Seeriate valiku keelamine lülitab välja ka seeriate riba, aga seeriate konfiguratsioon säilitatakse tulevikus kasutamiseks.",
      "settingsSeriesHelpContent2": "Rullimise seeriad lubavad Teil luua ja muuta asukohtade selektsiooni koos vastavate pealkirjade ja tekstidega. Kui Teie veebikaartidel on järjehoidjad, siis kuvatakse neid. Võite keelata seeriad, kuid konfiguratsioon säilitatakse võimalikuks kasutuseks tulevikuks.",
      "settingsSeriesHelpLink": "Vaadake rullitavate seeriatega rakenduse näidet siit",
      "preview": "UI vaade",
      ...
      "settingsLocateButton": "Luba toetatud brauserites asukoha määramise nupp",
      "settingsAddressSearch": "Luba aadressi otsimise tööriist"
    },
    "settingsSwipePopup": {
      "settingsSwipePopup": "Hüpikaken",
      "settingsSwipePopupExplain": "Kohandage hüpikakende päise välimust, et hõlbustada kasutajal seostada hüpikaknaid kaartide kihtidega.",
    ...
    "initPopup": {
      "initHeader": "Tere tulemast rullija/pikksilma koostajasse",
      "modalNext": "Järgmine",
      "modalPrev": "Eelmine",
      "modalApply": "Ava app"
    },
    "seriesPanel": {
      ...
      "discardDisabled": "Te ei saa seda järjehoidjat eemaldada. Rullimise seeriaid saab keelata seadetest."
    },
    "helpPopup": {
      "title": "Abi",
      "close": "Sulge",
      "tab1": {
        "div1": "Mall rullimine/pikksilm on loodud kahe erineva veebikaardi või ühe veebikaardi kahe kihi võrdlemiseks meeldivas ja lihtsasti kasutatavas veebirakenduses, mida saab kasutada mis tahes veebibrauseris ning seadmes, k.a nutitelefonides ja tahvelarvutites.",
