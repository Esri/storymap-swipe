	 ...
	 ({
		viewer: {
			...
			errors: {
				...
				invalidConfigNoWebmap: "Lỗi nghiêm trọng: Cấu hình không hợp lệ (không xác định được bản đồ web hoặc mã định danh ứng dụng trong index.html)",
				...
				notAuthorizedBuilder: "Bạn không có quyền sử dụng bộ thiết lập Trượt nhanh và Kính phóng đại.",
		...
		swipe: {
			...
			settingsLegend: {
				...
				settingsLegendHelpContent: "Để lọc các nội dung chú giải, sử dụng mục lục trình xem bản đồ web ArcGIS (Ẩn trong Chú giải)",
			...
			share: {
				firstSaveTitle: "Câu chuyện đã được lưu",
				...
				shareLinkHeader: "Chia sẻ câu chuyện của bạn",
				shareLinkOpen: "MỞ",
			...
			directCreation: {
				...
				explain2: "Để tạo một story map Trượt nhanh hoặc Kính thiên văn nhỏ, sử dụng nút dưới đây để chọn bản đồ web hiện tại mà bạn muốn sử dụng. Ngoài ra, bạn có thể dán các ID của bản đồ web vào trường bên dưới.",
