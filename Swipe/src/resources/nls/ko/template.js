define({
  "viewer": {
    ...
    "errors": {
      ...
      "invalidConfigNoAppDev": "URL 매개변수에 웹 매핑 응용프로그램 식별자(?appid=) 또는 웹맵(?webmap=)이 지정되어 있지 않습니다. 개발 모드에서 index.html의 AppId 및 웹맵 구성이 무시됩니다.",
      ...
      "notAuthorizedBuilder": "스와이프 및 투과 렌즈 빌더를 사용할 수 있는 권한이 없습니다.",
  ...
  "swipe": {
    ...
    "share": {
      ...
      "shareWarningWith1": "공개적으로 공유",
      "shareWarningWith2": "기관 내 공유"
    },
    "directCreation": {
